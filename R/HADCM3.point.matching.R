...
#' @param depth.level Numeric. The depth level to extract from the climate data file. Default is 1.
...
#' result <- HADCM3.point.matching(var = "insitu_T_ym_dpth", file = "o.pgclann", experiment = "experiment1", coord.dat = coord.dat)
#' }
#'
#' @import RNetCDF
#' @import dplyr
