#' HADCM3 Points Data
#'
#' This function matches palaeocoordinates to HADCM3L model data.
#'
#' @param var Character. The variable to extract from the HADCM3 model.
#' @param file A character string indicating the name of the NetCDF file (without the .nc extension).
#' @param experiment Character. The experiment identifier for the HADCM3 model.
#' @param depth.level Numeric. The depth level to extract from the HADCM3 model. Default is 1.
#' @param dims Numeric. The number of dimensions in the HADCM3 model. Default is 3.
#' @param year Year to extract data for (default is "default", meaning the last time point).
#' @param coord.dat Data frame. A data frame with latitude and longitude columns. HADCM3 data will be added to this and returned.
                               ...
                               )
{
  ...
  grid.dat <- HADCM3.grid(experiment = experiment,
                          file = file,
                          dims = dims)
